...
const CompMenuList: CompMenuProp[] = [
  {
    ...
    isGroup: true,
    children: [
      {id: "0-1", title: "Button", path: "/components/base/button"},
      {id: "0-2", title: "Switch", path: "/components/base/switch"}
    ]
  },
  {
    id: "1",
  ...
  },
  {
    ...
    isGroup: true,
    children: [
      {id: "2-1", title: "Input", path: "/components/import/input"},
      {id: "2-2", title: "Select", path: "/components/import/select"}
    ]
  }
]
const DevelopMenuList: DevelopMenuProp[] = [
  {
    ...
    isGroup: true,
    children: [
      {id: "0-1", title: "Color", path: "/develop/design/color"},
      {id: "0-2", title: "Font", path: "/develop/design/font"}
    ]
  },
  {
    id: "1",
    ...
    isGroup: true,
    children: [
      {id: "1-1", title: "UI resource", path: "/develop/design/resource"},
      {id: "1-2", title: "UI Icon", path: "/develop/design/icon"}
    ]
  }
]
